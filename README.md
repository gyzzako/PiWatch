...
```bash
curl -sSL https://raw.githubusercontent.com/gyzzako/PiWatch/main/scripts/install-server.sh | sudo bash \
...
```bash
curl -sSL https://raw.githubusercontent.com/gyzzako/PiWatch/main/scripts/install-agent.sh | sudo bash \
...
```bash
curl -sSL https://raw.githubusercontent.com/gyzzako/PiWatch/main/scripts/install-server.sh | sudo bash --uninstall
```

## Agent

```bash
curl -sSL https://raw.githubusercontent.com/gyzzako/PiWatch/main/scripts/install-agent.sh | sudo bash --uninstall
```
